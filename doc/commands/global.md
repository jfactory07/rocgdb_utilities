...
```text
global <addr-expr> [count] [hex|fp8|fp8e4m3fn|bf8|bf8e5m2|fp16|bf16|fp32] [--out PATH]
global <addr-lo-expr> <addr-hi-expr> [count] [hex|fp8|fp8e4m3fn|bf8|bf8e5m2|fp16|bf16|fp32] [--out PATH]
```
...
global $sgprAddressB 64 bf8
global $sgprAddressB 64 bf8e5m2
